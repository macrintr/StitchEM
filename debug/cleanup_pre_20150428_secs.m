...
%     secs{i}.params = params(i-start+1);
% end
% 
...
%         secs{i}.overview.alignments.rough_z.data = struct();
%         secs{i}.overview.alignments.rough_z.data.fixed_inliers = [];
%         secs{i}.overview.alignments.rough_z.data.moving_inliers = [];
%     end
