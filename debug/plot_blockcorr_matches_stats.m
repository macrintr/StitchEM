function stats = plot_blockcorr_matches_stats(secs, sec_num)
% Plot correspondence stats dataset for distributions

% Inputs:
%   sec: the section with blockcorr matches & alignment
%
% Outputs:
...
stats = calculate_matches_stats(secs{sec_num}.blockcorr_matches, tformsA, tformsB);
