...
class BlockMatcherParameters():
	def __init__(self,
		...
		project_folder = bucket + "tommy/trakem_tests/150703_elastic_redux/"
		# self.input_folder = project_folder + "affine_renders_0175x/"
		self.input_folder = project_folder + "renders/"
		# self.output_folder = project_folder + "affine_block_matching/all_points/"
		self.output_folder = project_folder + "block_matching/"
...
class BlockMatcher(Callable):
	...
	def call(self, save_images=False):
		...
		try:
			...
			ct = TranslationModel2D() # See TrakEM/../ElasticLayerAlignment.java:448
