...
tform_prescale = make_tform('scale', 1 / params.display_scale); % scale to full resolution assuming we start at display scale
tform_rescale = make_tform('scale', params.display_scale); % scale back down to display scale
